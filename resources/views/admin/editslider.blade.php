                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Modifier la diapositive</h3>
                            </div>
                            <!-- /.card-header -->
                            @if (count($errors) > 0)
                            ...
                            @method('PUT')
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Titre de la diapositive</label>
                                        <input type="text" name="title" value="{{$slider->title}}" class="form-control"
                                            id="exampleInputEmail1" placeholder="Entrer un nouveau titre" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Description de la diapositive</label>
                                        <input type="text" name="description" value="{{$slider->description}}" class="form-control"
                                            id="exampleInputEmail1" placeholder="Entrer une nouvelle description" required>
                                    </div>
